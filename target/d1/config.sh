...
# Device configuration file for Galaxy N10 (Exynos) (d1)
TARGET_NAME="Galaxy Note10 (Exynos)"
TARGET_CODENAME="d1"
TARGET_ASSERT_MODEL=("SM-N970F")
TARGET_PLATFORM="exynos9825"
TARGET_FIRMWARE="SM-N970F/BTU/359013100001650" # Some CSCs didn't received august 2023 update and since we don't use target's CSC we don't care about it
